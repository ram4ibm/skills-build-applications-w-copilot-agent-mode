...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        users = [
            ...
            {"username": "user3", "email": "user3@example.com", "password": "password3", "date_joined": datetime(2025, 4, 8)},
        ]

        teams = [
            {"name": "Team A", "members": ["user1_id"], "created_at": datetime(2025, 4, 8)},
            {"name": "Team B", "members": ["user2_id"], "created_at": datetime(2025, 4, 8)},
            {"name": "Team C", "members": ["user3_id"], "created_at": datetime(2025, 4, 8)},
        ]
        ...
        activities = [
            ...
            {"user_id": "user3_id", "activity_type": "Swimming", "duration": 60, "calories_burned": 500, "date": datetime(2025, 4, 8)},
        ]
        ...
        leaderboards = [
            ...
            {"team_id": "team_c_id", "total_points": 300, "last_updated": datetime(2025, 4, 8)},
        ]
        ...
        workouts = [
            ...
            {"name": "Pilates", "description": "Core strength and flexibility", "difficulty_level": "Intermediate", "duration": 45},
        ]
